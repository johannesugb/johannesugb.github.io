...
<div style="display:block;">
  ...
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(0.0,  0.5);" style="padding: 2px 5px; margin: 0 0 0 0;">[0, 0.5]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
  ...
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(0.0,  10000.0);" style="padding: 2px 5px; margin: 0 0 0 0;">[0.0,  10000]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(10000.0,  10000000.0);" style="padding: 2px 5px; margin: 0 0 0 0;">[10000,  10000000]</button>
  </div>
</div>
