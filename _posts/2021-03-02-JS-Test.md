...
<div style="display:block;">
  ...
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(0.0,  0.5);" style="padding: 2px 10px; margin: 0 0 0 0;">[0.0, 0.5]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(0.0,  1.0);" style="padding: 2px 10px; margin: 0 0 0 0;">[0.0,  1.0]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(-1.0,  1.0);" style="padding: 2px 10px; margin: 0 0 0 0;">[-1.0,  1.0]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(-100.0,  100.0);" style="padding: 2px 10px; margin: 0 0 0 0;">[-100.0,  100.0]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(0.0,  10000.0);" style="padding: 2px 10px; margin: 0 0 0 0;">[0.0,  10000.0]</button>
  </div>
  <div style="float:left; text-align:left; margin: 0px 10px 0px 0px;">
    <button id="sendButton" onclick="goGoPredefinedRange(10000.0,  10000000.0);" style="padding: 2px 10px; margin: 0 0 0 0;">[10000.0,  10000000.0]</button>
  </div>
</div>
...
function goGoPredefinedRange(double from, double to){
